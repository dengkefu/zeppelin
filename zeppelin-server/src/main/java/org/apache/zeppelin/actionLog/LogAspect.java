...
public class LogAspect {
     ...
     */
    @Pointcut("@annotation(org.apache.zeppelin.actionLog.OperationLogDetail)")
    ...
    private void addOperationLog(JoinPoint joinPoint, Object res, long time) {
        ...
        operationLog.setUserId(authenticationService.getPrincipal());
        ...
        LOG.error("记录日志:" + operationLog.toString());
